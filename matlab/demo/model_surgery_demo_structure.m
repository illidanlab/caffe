...
acc1 = test_func( net);
fprintf('** The truncated network (without structure change) has the accuracy of %.4f\n', acc1);
...
%%% strategy 2: use solver to instantiate an empty network. 
% In matlab, the solver 
...
acc3 = test_func( net);
fprintf('** The truncated network (with structure change) has the accuracy of %.4f\n', acc3);
